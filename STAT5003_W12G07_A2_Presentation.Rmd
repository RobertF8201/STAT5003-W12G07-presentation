...
<tbody>
  ...
  <tr><td style="padding:5px 10px; word-wrap:break-word;"><b>Imbalance strategy</b></td><td style="padding:5px 10px; word-wrap:break-word;">Inverse-frequency class weights (all models)</td></tr>
  <tr style="background:#f5f5f5;"><td style="padding:5px 10px; word-wrap:break-word;"><b>SMOTE</b></td><td style="padding:5px 10px; word-wrap:break-word;">Applied inside training fold only; synthetic Fatal share raised to ~10% in training</td></tr>
...
<b>Highest Fatal Recall (0.771) but extreme false alarms:</b> 4,133 of 5,253 actual Injury crashes predicted as Fatal, collapsing Macro-F1 to 0.243 and Kappa to 0.112.
</div>
