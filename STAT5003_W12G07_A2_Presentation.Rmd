...
<p style="font-size:11px; text-align:left; margin:0; line-height:1.2; background:#f9f9f9; padding:6px; ">
  <b>Key message:</b> Logistic Regression highlights several interpretable signals associated with crash severity, including <b>pedestrian involvement</b>, <b>street-lighting conditions</b>, and <b>impact type</b>, showing that the baseline model captures meaningful structure in the data.
</p>
</div>
</div>
...
<p style="font-size:10.5px; text-align:left; margin-top:4px; line-height:1.3; background:#f9f9f9; padding:5px; width:100%;"><b>Top predictors (Mean Decrease Accuracy):</b> Street lighting, Month of crash, LGA, Key TU type, First impact type, Longitude, Latitude - geographic and temporal factors feature prominently alongside structural ones. <i>Base model (pre-tuning) - mtry = 13 (tuned) shifts rankings slightly.</i></p>
</div>
...
<b>Top predictors by Gain:</b> Street lighting (Unknown/not stated) dominates at 0.30 gain, about 2.5x the next predictor. Distance, pedestrian/motorcycle involvement, Latitude/Longitude, and Speed limit (100 km/h) follow.
</p>
</div>
...
Geographic and temporal factors feature alongside structural ones - street lighting remains the dominant predictor, aligning with the EDA finding that darkness and rural high-speed conditions drive the highest Fatal risk.
</p>
...
<p style="font-size:12px; line-height:1.4; margin-bottom:6px;">2024 data sealed as an unseen <b>temporal holdout</b> (~35,000 records, natural ~1.4% Fatal). The model was trained at ~6% Fatal - a 4x higher Fatal rate than it encounters here.</p>
...
<tr>
  ...
  <td style="padding:4px 8px; text-align:center; color:#d62728; font-weight:bold;">0.097</td>
</tr>
<tr style="background:#f2f2f2;">
  <td style="padding:4px 8px;">Weighted F1</td>
...
<li><b>Temporal drift:</b> Fatal Recall drops from 0.51 (test) to 0.097 (holdout) - 2024 crash patterns were never seen during training</li>
<li><b>Class-proportion mismatch:</b> Both test and holdout have natural ~1.4% Fatal, but the model was trained at ~6% Fatal (undersampled training set) - a 4x rarer signal than it was calibrated for</li>
...
Of 528 actual Fatal crashes in the 2024 holdout, only <b>51 were correctly identified</b>; the remaining 477 were predicted as Injury. The model reverts to predicting the majority class when the minority is as rare as 1.4%, reinforcing the need for probability-threshold calibration or a dedicated rare-event model in production.
</p>
