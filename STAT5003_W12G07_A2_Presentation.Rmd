...
<b>Top predictors by Gain:</b> Street lighting (Unknown/not stated dummy) dominates with 0.30 gain, nearly 5x the next predictor. Distance, pedestrian/motorcycle involvement, Latitude/Longitude, and Speed limit (100 km/h) follow. Variable names reflect one-hot expanded columns.
</p>
</div>
...
<ul style="font-size:13px; line-height:1.7; margin-bottom:8px;">
<li>2024 crash records were entirely excluded from training and tuning, used solely as an unseen <b>temporal holdout</b> to simulate real deployment on future data</li>
<li>Holdout size: <b>~35,000 records</b> at the natural class distribution (~1.4% Fatal)</li>
<li>Compare to the model selection test set: ~13,500 records with ~6% Fatal (after undersampling)</li>
</ul>
...
<li><b>Fatal Recall dropped from 0.51 to 0.106</b> on the holdout, reflecting two compounding issues</li>
<li><b>Class-proportion mismatch:</b> Training used a balanced set where Fatal was ~6% of rows; in 2024 production data, fatals are back to ~1.4% - a 4x rarer signal the model is not calibrated for</li>
<li><b>Temporal drift:</b> Crash patterns, reporting conventions, or road infrastructure in 2024 may differ from the 2020-2023 training window in ways the model cannot anticipate</li>
<li>Together, these show that strong test-set metrics do not guarantee robustness in real deployment, especially for rare, high-consequence events</li>
</ul>
