...
<tbody>
  <tr><td style="padding:3px 8px;">OOB Error Rate</td><td style="padding:3px 8px; text-align:right;">26.92%</td></tr>
  <tr style="background:#f5f5f5;"><td style="padding:3px 8px;">Macro-F1</td><td style="padding:3px 8px; text-align:right;">0.6027</td></tr>
  <tr><td style="padding:3px 8px; color:#d62728;"><b>Fatal Recall</b></td><td style="padding:3px 8px; text-align:right; color:#d62728;"><b>0.3085</b></td></tr>
  <tr style="background:#f5f5f5;"><td style="padding:3px 8px;">Weighted F1</td><td style="padding:3px 8px; text-align:right;">0.7363</td></tr>
  <tr><td style="padding:3px 8px;">Kappa</td><td style="padding:3px 8px; text-align:right;">0.4603</td></tr>
</tbody>
</table>
</div>
</div>
...
<tr style="background:#f2f2f2;">
  ...
  <td style="padding:4px 8px; text-align:right;">0.5512</td>
</tr>

<tr>
  <td style="padding:4px 8px; color:#d62728; font-weight:bold;">Fatal Recall</td>
  <td style="padding:4px 8px; text-align:right; color:#d62728; font-weight:bold;">0.3564</td>
</tr>

<tr style="background:#f2f2f2;">
  <td style="padding:4px 8px;">Weighted F1</td>
  <td style="padding:4px 8px; text-align:right;">0.7319</td>
</tr>

<tr>
  <td style="padding:4px 8px;">Kappa</td>
  <td style="padding:4px 8px; text-align:right;">0.4235</td>
</tr>

</table>

<p style="font-size:13px; margin-top:8px; background:#fff8e1; padding:6px; border-left:3px solid #f0ad4e;">
⚠️ <b>Limitation:</b> Categorical features + Euclidean distance underestimates true similarity. Lower performance vs tree models is structurally expected.
</p>
...
tuning_tbl <- tibble::tibble(
  Model       = c("Logistic Regression", "Decision Tree", "Random Forest",
                  "XGBoost", "KNN (baseline)", "Naive Bayes"),
  ...
  `Best Value`       = c("0.01", "0.01*", "mtry = 9",   "500 / 4 / 0.05", paste0("k = sqrt(p)"), "usekernel = TRUE"),
  `Macro-F1 Before`  = c("0.440", "0.429", "0.6027",     "0.266", "0.551", "0.243"),
  `Macro-F1 After`   = c("0.442", "0.429*", "0.6189",    "0.302", "0.427", "0.245"),
  `Fatal Recall After` = c("0.761", "0.729*", "0.367",   "0.345", "0.200", "0.782")
)
...
> RF: `tuneRF` identified **mtry = 9** (default = 6) - Macro-F1 +0.016, Fatal Recall +0.059. mtry curve still declining at 9; OOB error still decreasing at ntree=100 — both suggest room for further gains with larger search.
...
<<<<<<< HEAD
                     "XGBoost", "KNN (baseline)", "Naive Bayes (tuned)"),
  `Macro-F1`     = c("0.442", "0.429", "0.619", "TODO", "0.551", "0.245"),
  `Fatal Recall` = c("0.761", "0.729", "0.367",     "TODO", "0.356", "0.782"),
  `Weighted F1`  = c("0.591", "0.584", "0.736",     "TODO", "0.732", "0.253"),
  `Kappa`        = c("0.272", "0.243", "0.460",     "TODO", "0.424", "0.112"),
  `Meets Fatal Recall >= 0.50` = c("Yes", "Yes", "No", "TODO", "No", "Yes")
=======
                     "XGBoost", "KNN (baseline)", "Naive Bayes (baseline)"),
  `Macro-F1`     = c("0.442", "0.429", "0.619", "0.266", "0.551", "0.205"),
  `Fatal Recall` = c("0.761", "0.729", "0.367",     "0.33", "0.356", "0.856"),
  `Weighted F1`  = c("0.591", "0.584", "0.736",     "0.399", "0.732", "0.188"),
  `Kappa`        = c("0.272", "0.243", "0.460",     "0.003", "0.424", "0.086"),
  `Meets Fatal Recall >= 0.50` = c("Yes", "Yes", "No", "No", "No", "Yes")
>>>>>>> d5ee7a2 (model evaluation xgboost)
)
